...
def preprocessing_1_hour(data):
    ...
    # Remove features
    #initially
    d_features_to_drop = ["apache_4a_icu_death_prob","h1_sysbp_noninvasive_max","h1_sysbp_noninvasive_min","h1_mbp_noninvasive_max","h1_mbp_noninvasive_min","h1_diasbp_noninvasive_max", "h1_diasbp_noninvasive_min","height","icu_id","readmission_status","weight","encounter_id", "patient_id","hospital_admit_source", "icu_stay_type", "icu_type", "leukemia", "aids", "lymphoma"]
    h1_data = no_nulls.drop(columns= d_features_to_drop)
    #after SHAP evaluation
    more_to_drop = ["h1_mbp_max", "h1_mbp_min","h1_diasbp_max","h1_diasbp_min","ethnicity","icu_admit_source","solid_tumor_with_metastasis","immunosuppression","hepatic_failure","diabetes_mellitus","hospital_id", "cirrhosis", "h1_resprate_max", "h1_temp_max", "h1_resprate_min", "h1_temp_min"]
